...
WebUI.setText(findTestObject('Website A/Buat akun page/Field_Whatsapp'), '1234567889')
...
WebUI.click(findTestObject('Object Repository/Website A/Homepage/icon_Coding ID'))
