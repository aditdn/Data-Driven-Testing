...
WebUI.setText(findTestObject('Website A/Buat akun page/Field_tanggal lahir'), '29-Mar-2000')

WebUI.setText(findTestObject('Website A/Buat akun page/Field_E-Mail'), 'contoh@mail.com')

WebUI.setText(findTestObject('Website A/Buat akun page/Field_Whatsapp'), '1234567812345678')
...
WebUI.verifyElementText(findTestObject('Website A/Edit profile page/Text_The whatsapp must be between 10 and 12 digits fix'), 'The whatsapp must be between 10 and 12 digits.')
