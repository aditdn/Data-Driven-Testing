...
WebUI.setText(findTestObject('Website A/Buat akun page/Field_tanggal lahir'), '29-Mar-1997')

WebUI.setText(findTestObject('Website A/Buat akun page/Field_E-Mail'), 'contoh@mail.com')

WebUI.setText(findTestObject('Website A/Buat akun page/Field_Whatsapp'), '123')
