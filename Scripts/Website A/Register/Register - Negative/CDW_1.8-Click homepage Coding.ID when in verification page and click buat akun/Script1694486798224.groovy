...
WebUI.setText(findTestObject('Website A/Buat akun page/Field_Whatsapp'), '12345678')
...
WebUI.click(findTestObject('Website A/Homepage/icon_Coding ID'))

WebUI.verifyElementClickable(findTestObject('Website A/Homepage/Btn_buat akun'))
